...
from PyQt5.QtGui import QFont, QPixmap, QPainter, QPainterPath, QColor, QIcon
...
class ForgotPassWindow(QWidget):
    ...
    def save_password(self):
        ...
        success, msg = self.update_password(self.email, p1)
    ...
    def update_password(self, email, new_pass):
        try:
            ...
            updated_admin = cursor.rowcount

            self.auth.conn.commit()

            if updated_students == 0 and updated_admin == 0:
    ...
    def init_ui(self):
        ...
        # -------------------- SUBTEXT --------------------
        create = QLabel("Enter your New Password")
        ...
        p_lbl = QLabel("Enter New Password")
        ...
        self.password.setPlaceholderText("SamplePassword123")
        self.password.setEchoMode(QLineEdit.Password)
        ...
        left_layout.addSpacing(2)
        cp_lbl = QLabel("Confirm New ssword")
        ...
        self.conpassword.setPlaceholderText("SampleConfirmPassword123")
        self.conpassword.setEchoMode(QLineEdit.Password)
    ...
    def handle_reset(self):
        p1 = self.password.text().strip()
        p2 = self.conpassword.text().strip()
...
def LoginMain():
    ...
    app.setStyle("Fusion")
    w = ForgotPassWindow("test@email.com")
    w.showNormal()
    sys.exit(app.exec_())
